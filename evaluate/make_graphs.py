...
parser.add_argument("--data_folder", default=None, help="path to data output")
parser.add_argument("--data", nargs="+", default=None, help="list of csv files")
parser.add_argument("--labels", nargs="+", default=None, help="labels to put")
parser.add_argument("--colours", nargs="+", default=None, help="")

parser.add_argument("--outf", default=None, help="where to put the data")

parser.add_argument("--threshold", default=0.1, type=float)
parser.add_argument("--title", default="AUC")
parser.add_argument("--filename", default="output")
parser.add_argument("--styles", nargs="+", default=None, help="")
parser.add_argument("--show", action="store_true", help="show the graph at the end. ")
...
for i_file, file in enumerate(adds_to_load):
    ...
    print(
        ...
        add_pnp_found.std(),
        "ratio",
        f"{len(add_pnp_found)}/{n_pnp_possible_frames}",
    )
    n_pnp_found = len(add_pnp_found)

    delta_threshold = 0.00001
    add_threshold_values = np.arange(0.0, opt.threshold, delta_threshold)
